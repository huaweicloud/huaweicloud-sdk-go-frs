...
func newSearchServiceV2(accessService *access.AccessService, projectId string) *SearchServiceV2 {
	return &SearchServiceV2{accessService, projectId}
}

func (searchService *SearchServiceV2) searchFace(faceSetName string, image string, imageType int, topN int, threshold float64,
...
//base64
func (searchService *SearchServiceV2) SearchFaceByBase64Full(faceSetName string, imageBase64 string, topN int, threshold float64,
	searchSort *param.SearchSort, searchReturnFields *param.SearchReturnFields, filter string) (*result.SearchFaceResult, error) {
...
//file
func (searchService *SearchServiceV2) SearchFaceByFileFull(faceSetName string, imagePath string, topN int, threshold float64,
	searchSort *param.SearchSort, searchReturnFields *param.SearchReturnFields, filter string) (*result.SearchFaceResult, error) {
	uri := fmt.Sprintf(_FACE_SEARCH_URI, searchService.projectId, faceSetName)
	buffer := &bytes.Buffer{}
...
//obs url
func (searchService *SearchServiceV2) SearchFaceByObsUrlFull(faceSetName string, imageUrl string, topN int, threshold float64,
	searchSort *param.SearchSort, searchReturnFields *param.SearchReturnFields, filter string) (*result.SearchFaceResult, error) {
...
//face id
func (searchService *SearchServiceV2) SearchFaceByFaceIdFull(faceSetName string, faceId string, topN int, threshold float64,
	searchSort *param.SearchSort, searchReturnFields *param.SearchReturnFields, filter string) (*result.SearchFaceResult, error) {
